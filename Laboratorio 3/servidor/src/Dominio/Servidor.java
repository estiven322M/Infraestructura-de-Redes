...
public class Servidor implements IServicioLibros {
	...
	/*public static void main(String[] args) {
		...
		inicializarUsuarios();
		Servidor servidorInstancia = new Servidor();
	...
	public static void main(String[] args) {
        inicializarUsuarios();
        //Servidor servidorInstance = new Servidor();
        try {
            ...
            while (true) {
                ...
                System.out.println("Cliente conectado.");
                new Servidor ().manejarCliente(socketServidor);
            }
        } catch (IOException e) {
	...
	private  void reservarLibro(BufferedReader entrada, PrintWriter salida) {
	    try {
	...
	private  void buscarLibro(BufferedReader entrada, PrintWriter salida) {
		try {
			// Solicitas el nombre del libro al cliente
	...
	private  void manejarCliente(Socket socketServidor) throws IOException {
        try (PrintWriter salida = new PrintWriter(new OutputStreamWriter(socketServidor.getOutputStream(), "UTF-8"));
            ...
            if (validarCredenciales(email, clave)) {
                ...
                while (activo) {
                    ...
                    salida.println("1 - Buscar libro");
                    salida.println("2 - Reservar libro");
                    salida.println("3 - Cambiar clave");
